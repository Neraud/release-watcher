...
class RawHtmlWatcher(Watcher):
    ...
    def _do_watch(self) -> WatchResult:
        ...
        for item_element in item_elements:
            item_id = self._extract_value(item_element,
                                          self.config.id_selector,
                                          self.config.id_attribute)
            item_date_string = self._extract_value(item_element,
    ...
    def _extract_value(self, item_element, attr_selector, attr_property):
...
class RawHtmlWatcherType(WatcherType):
    ...
    def create_watcher(self, watcher_config: RawHtmlWatcherConfig) -> RawHtmlWatcher:
