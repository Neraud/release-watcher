...
class FileSourceType(SourceType):
    ...
    def parse_config(self, global_conf: Dict, source_config: Dict) -> FileSourceConfig:
    ...
    def create_source(self, common_config: CommonConfig, config: FileSourceConfig) -> FileSource:
